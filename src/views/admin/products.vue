    ...
    >
        ...
        <div class="w-full flex items-center justify-end">
            <div class="center relative">
                ...
                <button
                    class="flex items-center gap-1 hover:text-black text-sm rounded-xl border border-neutral-200 hover:bg-blue-50 px-2 py-1"
                    @click="toggleDeleteProduct || showEditButton"
                    v-else
                >
                    Cancel
                </button>
                ...
                >
                    ...
                    <button
                        class="w-full px-2 py-1 bg-blue-200/80 border border-blue-400 text-blue-400 rounded-lg center gap-1 sm:text-xs text-sm hover:bg-blue-100"
                        @click="
                            () => {
                    ...
                    <button
                        class="px-2 py-1 bg-green-600 text-white rounded-lg center gap-1 sm:text-xs text-sm hover:opacity-90"
                        @click="
                            () => {
                ...
                >
                    ...
                    >
                        ...
                        <button
                            ...
                            class="text-blue-400 bg-blue-50 p-1 rounded-full absolute -top-3 -right-3 shadow-lg"
                            v-if="editButton"
                        >
                            <svg
                                width="24"
        ...
        >
            ...
            >
                ...
                <button
                    @click="deleteProductNow(selectedProductId)"
