...
<template>
    <div>
        ...
        >
            ...
            <div class="col-center w-full text-center md:space-y-7 space-y-5 px-4 z-10">
                <div class="">
                    <h1 class="md:text-8xl lg:text-9xl text-4xl sm:text-6xl font-medium mb-1">
                        Celine's Treats
                    </h1>
                    <h2 class="text-2xl md:text-4xl">Simple. Quality. Essential</h2>
        ...
        <section class="min-h-96 w-full px-3 center py-5 md:py-10">
            <div class="col-center w-full md:w-[80%] h-full space-y-5 p-2">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6 w-full">
                    <div
                        ...
                        :key="items.id"
                        class="section-bg prod-cards hover w-full rounded-xl p-2 shadow"
                    >
