    ...
    <div class="min-h-screen w-full">
        ...
        <div class="col-center w-full min-h-96 primary-bg">
            <section class="min-h-96 w-full py-5 md:py-16 px-1">
                <div class="col-center h-full md:p-5 md:py-0 px-0 py-5 space-y-8">
                    ...
                    <section class="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
                        ...
                        <div
                            class="h-72 flex flex-col justify-between items-center space-y-5 max-w-[350px] md:max-w-[320px] px-2 py-4 text-center shadow-xs rounded-2xl fade-in prod-cards bg-blue-400 hover:bg-white hover:text-neutral-600 text-white"
                            id="sec"
                        >
                            <div
                                id="secd"
            ...
            <section class="min-h-92 w-full center py-5 md:py-10 secondary-bg">
                <div class="col-center w-[90%] xl:w-[80%] h-full space-y-5 p-2">
